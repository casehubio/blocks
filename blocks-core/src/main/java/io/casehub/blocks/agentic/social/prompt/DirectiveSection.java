...
public class DirectiveSection implements PromptSection {
    ...
    private DirectiveSection(PromptSection delegate, String directive) {
    ...
    public static PromptSection wrap(PromptSection section) {
